defmodule ExOnvif.ReplayTest do
  ...
  test "get replay uri" do
    ...
    assert {:ok, response} =
             ExOnvif.Replay.get_replay_uri(device, "SD_DISK_20200422_132655_67086B52")
  ...
  test "get service capabitiies" do
    ...
    {:ok, response} = ExOnvif.Replay.get_service_capabilities(device)
